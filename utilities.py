...
def save_hyperparams(batch_size, state_size, replay_start_size, eps_start, eps_end, m, target_update, gamma, capacity, learning_rate, no_rep_action, last_game_avg):
    path = create_folder()
